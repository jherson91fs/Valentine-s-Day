document.addEventListener("DOMContentLoaded", () => {
    ...
    function typeMessage() {
        const text = "ae eum, volhgfd hgfdhfg dhf gdhfg dhfgd hf gdhfgdhf gdhf gdhfg dhfgd hfgd hgfhf dghf gdh fgdhf gd hfdgh upta tibus, clat eveniet. Querida persona especial,\n\nEspero que esta carta ilumine tu día. Eres increíble y mereces toda la felicidad del mundo.\n\nCon cariño,\nTu persona especial 💖";
        let i = 0;
        message.innerHTML = "";
